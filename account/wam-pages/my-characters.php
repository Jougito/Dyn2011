		     ...
		     <table class="body3" cellspacing="0" cellpadding="0">
			   <tr>
			     <td class="body3-title">
				     ...
				     Jugadores en la Cuenta: "<?php echo $user_check_accountname; ?>"<img class="nav-icon" src="<?php echo theme_file("images/icons/characters.png"); ?>" alt="Saját karakterek" />
			   ...
			   <tr>
			     <td class="body3-body">
				     ...
				     <table class="location-info" cellspacing="0" cellpadding="0">
                        <tr>
						  ...
						  Aquí puedes encontrar información acerca de tus personajes en Vesperia.
				 ...
				 <table cellspacing="0" cellpadding="0" class="body5">
				   <tr>
					    <td align="center" colspan="5">Número de personajes: <b><?php echo $rows_mycharacters; ?></b></td>
				   </tr>
				 </table>
					 ...
					 echo '
						...
						while($results_mycharacters = mysqli_fetch_array($query_mycharacters)){
							...
							// Fajok és kasztok átalakítása képpé
							 $results_mycharacters_race = '<img src="dyn-images/'.$results_mycharacters["race"].'-'.$results_mycharacters["gender"].'.gif" alt="" />';
							 $results_mycharacters_class = '<img src="dyn-images/'.$results_mycharacters["class"].'.gif" alt="" />';
							
							echo "<tr><td><b>".$results_mycharacters["name"]."</b></td><td><b>".$results_mycharacters_race."</b></td><td><b>".$results_mycharacters_class."</b></td><td><b>".$results_mycharacters["level"]."</b></td><td><b><a href='?id=character-rename'>Renombrar Jugador</a></td></tr>";
