...
<table class="body3" cellspacing="0" cellpadding="0">
			   ...
			   <tr>
				 ...
				 <table cellspacing="0" cellpadding="0" class="body5">
					   ...
					   <tr>
					     <td width="150px" align="center">
						  <img src="/imagesv/objetos/lupa.png" onMouseOver="this.src='/imagesv/objetos/cambio.jpg'" onMouseOut="this.src='/imagesv/objetos/lupa.png'" style="cursor:pointer;">
						</p>
						 </td>
					   </tr>
				   <tr>
				     <td align="center">
					 <?php $soap_command = ExecuteSoapCommand('char customize '.$_POST["pj"].' ');
if($soap_command['sent'])
    echo("<center>Personalizacion de PJ activada.</p>Cuando inicies sesion tendras la posibilidad del cambio de aspecto.</center>");
