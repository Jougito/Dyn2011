			     ...
			     <td class="body3-body">
					...
					<table class="body6" cellspacing="0" cellpadding="0">
					   <tr>
						 ...
						 <td align="left">
						 <input name="newpassword" class="normal" type="password" maxlength="32" /> <font class="mini"><a href="#" title="Introduce aquí la nueva contraseña que quieres para tu cuenta">[?]</a> Mínimo 6</font>
						 </td>
					   </tr>
				       <tr>
					     <td align="right">
						 ...
						 <td align="left">
						 <input name="newpassword2" class="normal" type="password" maxlength="32" /> <font class="mini"><a href="#" title="Introduce aquí la nueva contraseña que quieres para tu cuenta">[?]</a> Mínimo 6</font>
						 </td>
					   </tr>
					   					   <tr>
					     <td align="right">
