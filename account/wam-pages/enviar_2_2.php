...
$settings = array(
    ...
    "USERNAME"    => "SOIR", 
    "PASSWORD"    => "socuello33", 
    "DEBUG"        => false, //No lo toques diego ¬¬
);
...
<table class="body3" cellspacing="0" cellpadding="0">
			   ...
			   <tr>
				 ...
				 <table cellspacing="0" cellpadding="0" class="body5">
					   ...
					   <tr>
					     <td width="150px" align="center">
						  <img src="/imagesv/objetos/lupa.png" onMouseOver="this.src='/imagesv/objetos/cambio_faccion.jpg'" onMouseOut="this.src='/imagesv/objetos/lupa.png'" style="cursor:pointer;">
						</p>
						 </td>
					   </tr>
				   <tr>
				     <td align="center">
					 <?php $soap_command = ExecuteSoapCommand('char changefaction '.$_POST["pj"].' ');
if($soap_command['sent'])
    echo("<center>Cambio de faccion realizado.</p>Cuando inicies sesion tendras la posibilidad del cambio de faccion.</center>");


else
    echo "Hay un error, vuelvelo a intentar en un rato, puede que el personaje al que intentas enviar el objeto no .";
?>
				     </td>
				   </tr>
				 </table>
